...
<Hero heroImage="/assets/images/heros/achero1.jpg" heroTitle="Aries Mechanical" heroBigText="Furnace Repair & Installation Services in {nnCity}, {nnState}" heroText="">
    <p>For over 25 years, residents in {nnCity}, {nnState} have relied on Aries Mechanical to keep their families safe and their furnace systems running efficiently.</p>
